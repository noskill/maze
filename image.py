...
class Image(object):
    ...
    def draw_box(self):
        ...
        pygame.draw.line(self.background, (0,0,0), self.flip_y(start_pos), self.flip_y(end_pos))
    ...
    def update_text(self, a_pos, a_value):
        ...
        self.text_map[tuple(self.flip_y(pos))] = self.text_cache[value]
    ...
    def update(self, delta):
        ...
        self.screen.blit(self.arrow, self.flip_y(self.pos))
